...
type RegistrySetup = {
  memberRegistry: NetworkRegistry;
}
...
describe("NetworkRegistry", function () {
  ...
  let memberRegistry: NetworkRegistry;
  ...
  beforeEach(async function () {
    ...
    const registrySetup = deployments.createFixture<RegistrySetup, any>(
      ...
      const registryDeployed = await deployments.deploy('NetworkRegistry', {
      ...
      const memberRegistry = (await ethers.getContractAt('NetworkRegistry', registryDeployed.address, signer) as NetworkRegistry);
