...
contract GasUsage_V2_Fork_Test is Test {
    ...
    NetworkRegistryV2 private registry;
    ...
    function setUp() external {
        ...
        bytes memory mainInitParams = abi.encode(connext, 0, address(0), split, registryOwner);
        // USING SUMMONER
        ...
        bytes memory initializerData = abi.encodeCall(NetworkRegistryV2.initialize, (mainInitParams));
        registry = new NetworkRegistryV2();
        ...
        registry = NetworkRegistryV2(proxy);
        ...
        registry.syncBatchNewMembers(memberAddresses, _activityMultipliers, _startDates, chainIds, relayerFees);
    ...
    function testSyncUpdateSecondsActive() external moveForwardTime(86_400) ownerContext {
        registry.syncUpdateSecondsActive(chainIds, relayerFees);
    }

    function testSyncUpdateAll() external moveForwardTime(86_400) ownerContext {
        registry.syncUpdateAll(memberAddresses, 0, chainIds, relayerFees);
    }
}
