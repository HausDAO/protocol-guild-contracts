...
contract SplitMain is ISplitMain {
    ...
    mapping(IERC20 => mapping(address => uint256)) internal erc20Balances;
     ...
     */
    function withdraw(address account, uint256 withdrawETH, IERC20[] calldata tokens) external override {
     ...
     */
    function getERC20Balance(address account, IERC20 token) external view returns (uint256) {
     ...
     */
    function _withdrawERC20(address account, IERC20 token) internal returns (uint256 withdrawn) {
        // leave balance of 1 for gas efficiency
